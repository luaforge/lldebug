...
//
// Created:     13-Jan-2000
// RCS-ID:      $Id: ScintillaWX.cpp,v 1.1 2008-12-29 02:24:46 cielacanth Exp $
...
BEGIN_EVENT_TABLE(wxSCICallTip, wxSCICallTipBase)
	...
	EVT_LEAVE_WINDOW(wxSCICallTip::OnLeaveWindow)
END_EVENT_TABLE()
...
void ScintillaWX::DoAddChar(int key) {
    ...
    AddCharUTF((char*)buf.data(), (unsigned int)strlen(buf));
#else
    AddChar((char)key);
#endif
}
